...
func TestIntendedInlining(t *testing.T) {
	...
	want := map[string][]string{
		...
		"github.com/pgavlin/gc/runtime/sys": {},
		"github.com/pgavlin/gc/runtime/math": {
			"MulUintptr",
		},
		"bytes": {
			"(*Buffer).Bytes",
	...
	if runtime.GOARCH != "386" {
		...
		want["github.com/pgavlin/gc/runtime/sys"] = append(want["github.com/pgavlin/gc/runtime/sys"], "Ctz64")
		want["github.com/pgavlin/gc/runtime/sys"] = append(want["github.com/pgavlin/gc/runtime/sys"], "Ctz32")
		want["github.com/pgavlin/gc/runtime/sys"] = append(want["github.com/pgavlin/gc/runtime/sys"], "Bswap32")
	}
	if bits.UintSize == 64 {
