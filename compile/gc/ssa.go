...
import (
	...
	"github.com/pgavlin/gc/compile/types"
	"github.com/pgavlin/gc/obj"
	"github.com/pgavlin/gc/obj/x86"
...
func init() {
	...
	addF("github.com/pgavlin/gc/runtime/math", "MulUintptr",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Load",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Load8",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Load64",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "LoadAcq",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
		...
		sys.PPC64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Loadp",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Store",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			s.vars[&memVar] = s.newValue3(ssa.OpAtomicStore32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Store8",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			s.vars[&memVar] = s.newValue3(ssa.OpAtomicStore8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Store64",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			s.vars[&memVar] = s.newValue3(ssa.OpAtomicStore64, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "StorepNoWB",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			s.vars[&memVar] = s.newValue3(ssa.OpAtomicStorePtrNoWB, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "StoreRel",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Xchg",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Xchg64",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Xadd",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Xadd64",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "Cas",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Cas64",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "CasRel",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			v := s.newValue4(ssa.OpAtomicCompareAndSwap32, types.NewTuple(types.Types[TBOOL], types.TypeMem), args[0], args[1], args[2], s.mem())
			s.vars[&memVar] = s.newValue1(ssa.OpSelect1, types.TypeMem, v)
			return s.newValue1(ssa.OpSelect0, types.Types[TBOOL], v)
	...
	addF("github.com/pgavlin/gc/runtime/atomic", "And8",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
			s.vars[&memVar] = s.newValue3(ssa.OpAtomicAnd8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.PPC64, sys.S390X)
	addF("github.com/pgavlin/gc/runtime/atomic", "Or8",
		func(s *state, n *Node, args []*ssa.Value) *ssa.Value {
	...
	alias("github.com/pgavlin/gc/runtime/atomic", "Loadint64", "github.com/pgavlin/gc/runtime/atomic", "Load64", all...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Xaddint64", "github.com/pgavlin/gc/runtime/atomic", "Xadd64", all...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Loaduint", "github.com/pgavlin/gc/runtime/atomic", "Load", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Loaduint", "github.com/pgavlin/gc/runtime/atomic", "Load64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Loaduintptr", "github.com/pgavlin/gc/runtime/atomic", "Load", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Loaduintptr", "github.com/pgavlin/gc/runtime/atomic", "Load64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "LoadAcq", "github.com/pgavlin/gc/runtime/atomic", "Load", lwatomics...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Storeuintptr", "github.com/pgavlin/gc/runtime/atomic", "Store", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Storeuintptr", "github.com/pgavlin/gc/runtime/atomic", "Store64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "StoreRel", "github.com/pgavlin/gc/runtime/atomic", "Store", lwatomics...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Xchguintptr", "github.com/pgavlin/gc/runtime/atomic", "Xchg", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Xchguintptr", "github.com/pgavlin/gc/runtime/atomic", "Xchg64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Xadduintptr", "github.com/pgavlin/gc/runtime/atomic", "Xadd", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Xadduintptr", "github.com/pgavlin/gc/runtime/atomic", "Xadd64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Casuintptr", "github.com/pgavlin/gc/runtime/atomic", "Cas", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Casuintptr", "github.com/pgavlin/gc/runtime/atomic", "Cas64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Casp1", "github.com/pgavlin/gc/runtime/atomic", "Cas", p4...)
	alias("github.com/pgavlin/gc/runtime/atomic", "Casp1", "github.com/pgavlin/gc/runtime/atomic", "Cas64", p8...)
	alias("github.com/pgavlin/gc/runtime/atomic", "CasRel", "github.com/pgavlin/gc/runtime/atomic", "Cas", lwatomics...)
	...
	addF("math/bits", "TrailingZeros8",
		...
		sys.S390X)
	alias("math/bits", "ReverseBytes64", "github.com/pgavlin/gc/runtime/sys", "Bswap64", all...)
	alias("math/bits", "ReverseBytes32", "github.com/pgavlin/gc/runtime/sys", "Bswap32", all...)
	...
	alias("github.com/pgavlin/gc/runtime/sys", "Ctz8", "math/bits", "TrailingZeros8", all...)
	alias("github.com/pgavlin/gc/runtime/sys", "TrailingZeros8", "math/bits", "TrailingZeros8", all...)
	alias("github.com/pgavlin/gc/runtime/sys", "TrailingZeros64", "math/bits", "TrailingZeros64", all...)
	alias("github.com/pgavlin/gc/runtime/sys", "Len8", "math/bits", "Len8", all...)
	alias("github.com/pgavlin/gc/runtime/sys", "Len64", "math/bits", "Len64", all...)
	alias("github.com/pgavlin/gc/runtime/sys", "OnesCount64", "math/bits", "OnesCount64", all...)

	/******** sync/atomic ********/

	// Note: these are disabled by flag_race in findIntrinsic below.
	alias("sync/atomic", "LoadInt32", "github.com/pgavlin/gc/runtime/atomic", "Load", all...)
	alias("sync/atomic", "LoadInt64", "github.com/pgavlin/gc/runtime/atomic", "Load64", all...)
	alias("sync/atomic", "LoadPointer", "github.com/pgavlin/gc/runtime/atomic", "Loadp", all...)
	alias("sync/atomic", "LoadUint32", "github.com/pgavlin/gc/runtime/atomic", "Load", all...)
	alias("sync/atomic", "LoadUint64", "github.com/pgavlin/gc/runtime/atomic", "Load64", all...)
	alias("sync/atomic", "LoadUintptr", "github.com/pgavlin/gc/runtime/atomic", "Load", p4...)
	alias("sync/atomic", "LoadUintptr", "github.com/pgavlin/gc/runtime/atomic", "Load64", p8...)

	alias("sync/atomic", "StoreInt32", "github.com/pgavlin/gc/runtime/atomic", "Store", all...)
	alias("sync/atomic", "StoreInt64", "github.com/pgavlin/gc/runtime/atomic", "Store64", all...)
	// Note: not StorePointer, that needs a write barrier.  Same below for {CompareAnd}Swap.
	alias("sync/atomic", "StoreUint32", "github.com/pgavlin/gc/runtime/atomic", "Store", all...)
	alias("sync/atomic", "StoreUint64", "github.com/pgavlin/gc/runtime/atomic", "Store64", all...)
	alias("sync/atomic", "StoreUintptr", "github.com/pgavlin/gc/runtime/atomic", "Store", p4...)
	alias("sync/atomic", "StoreUintptr", "github.com/pgavlin/gc/runtime/atomic", "Store64", p8...)

	alias("sync/atomic", "SwapInt32", "github.com/pgavlin/gc/runtime/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapInt64", "github.com/pgavlin/gc/runtime/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUint32", "github.com/pgavlin/gc/runtime/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapUint64", "github.com/pgavlin/gc/runtime/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUintptr", "github.com/pgavlin/gc/runtime/atomic", "Xchg", p4...)
	alias("sync/atomic", "SwapUintptr", "github.com/pgavlin/gc/runtime/atomic", "Xchg64", p8...)

	alias("sync/atomic", "CompareAndSwapInt32", "github.com/pgavlin/gc/runtime/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapInt64", "github.com/pgavlin/gc/runtime/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUint32", "github.com/pgavlin/gc/runtime/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapUint64", "github.com/pgavlin/gc/runtime/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUintptr", "github.com/pgavlin/gc/runtime/atomic", "Cas", p4...)
	alias("sync/atomic", "CompareAndSwapUintptr", "github.com/pgavlin/gc/runtime/atomic", "Cas64", p8...)

	alias("sync/atomic", "AddInt32", "github.com/pgavlin/gc/runtime/atomic", "Xadd", all...)
	alias("sync/atomic", "AddInt64", "github.com/pgavlin/gc/runtime/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUint32", "github.com/pgavlin/gc/runtime/atomic", "Xadd", all...)
	alias("sync/atomic", "AddUint64", "github.com/pgavlin/gc/runtime/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUintptr", "github.com/pgavlin/gc/runtime/atomic", "Xadd", p4...)
	alias("sync/atomic", "AddUintptr", "github.com/pgavlin/gc/runtime/atomic", "Xadd64", p8...)
